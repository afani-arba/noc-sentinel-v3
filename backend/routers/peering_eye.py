...
PLATFORM_META = {
    ...
    "Telegram":     {"icon": "✈",  "color": "#2CA5E0"},
    "Discord":      {"icon": "🎮", "color": "#5865F2"},
    "Google":       {"icon": "🔍", "color": "#4285F4"},
    "Microsoft":    {"icon": "🪟", "color": "#0078D4"},
    "Apple/iCloud": {"icon": "🍎", "color": "#555555"},
    "Cloudflare":   {"icon": "☁",  "color": "#F38020"},
    "Amazon/AWS":   {"icon": "📦", "color": "#FF9900"},
    "Zoom":         {"icon": "📹", "color": "#2D8CFF"},
    "Google Meet":  {"icon": "📹", "color": "#00832D"},
    "Tokopedia":    {"icon": "🛒", "color": "#03AC0E"},
    "Shopee":       {"icon": "🛍", "color": "#EE4D2D"},
    "Gojek/GoTo":   {"icon": "🚗", "color": "#00AED6"},
    "Grab":         {"icon": "🚕", "color": "#00B14F"},
    "Bukalapak":    {"icon": "🛒", "color": "#E31E52"},
    "Traveloka":    {"icon": "✈",  "color": "#038CC1"},
    "Steam":        {"icon": "🎮", "color": "#1B2838"},
    "Riot Games":   {"icon": "⚔",  "color": "#C6272F"},
    "Epic Games":   {"icon": "🎮", "color": "#2F2F2F"},
    "Garena":       {"icon": "🎮", "color": "#F4821F"},
    "Mobile Legends":{"icon": "⚔", "color": "#F5A623"},
